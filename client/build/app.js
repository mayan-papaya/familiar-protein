	      ...
	      React.createElement("div", null, 
	        React.createElement("div", {className: "row"}, 
	          React.createElement("div", {className: "col-md-8 col-md-offset-2"}, 
	            ...
	            React.createElement("div", {className: "row col-md-4 signin-margin"}, 
	              React.createElement("form", {onSubmit: this.handleSubmit}, 
	              React.createElement("input", {type: "text", className: "form-control input-md", required: true, ref: "name", className: "text", placeholder: "Username"}), 
	              React.createElement("div", null), 
	              React.createElement("input", {type: "password", className: "form-control input-md", required: true, ref: "password", className: "text", placeholder: "Password"}), 
	              React.createElement("input", {type: "submit", className: "btn btn-primary", value: "Submit"})
	              )
	            ), 
	            React.createElement("br", null), 
	            React.createElement("div", {className: "row"}, 
	              React.createElement("div", {className: "col-md-4"}, "Need new account?")
	            ), 
	            React.createElement("div", {className: "row"}, 
	      ...
	      React.createElement("div", null, 
	        React.createElement("div", {className: "row"}, 
	          React.createElement("div", {className: "col-md-8 col-md-offset-2"}, 
	            ...
	            React.createElement("div", {className: "row col-md-4 signup-margin"}, 
	              React.createElement("form", {onSubmit: this.handleSubmit}, 
	              React.createElement("input", {type: "text", className: "form-control input-md", required: true, ref: "name", className: "text", placeholder: "Username"}), 
	              React.createElement("br", null), 
	              React.createElement("input", {type: "password", className: "form-control input-md", required: true, ref: "password", className: "text", placeholder: "Password"}), 
	              React.createElement("input", {type: "password", className: "form-control input-md", required: true, className: "text", placeholder: "Confirm Password"}), 
	              React.createElement("input", {type: "submit", className: "btn btn-primary", value: "Submit"})
	              )
	            ), 
	            React.createElement("br", null), 
	            React.createElement("div", {className: "row"}, 
	              React.createElement("div", {className: "col-md-4"}, "Already have an account?")
	            ), 
	            React.createElement("div", {className: "row"}, 
	              React.createElement("div", {className: "col-md-4"}, 
